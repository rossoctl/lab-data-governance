...
- **Sidecar algorithm — fully observed legs (Case-Y, ADR-0028).** The
...
(`sidecar._write`, ADR-0028 — its whole-trace reconcile needs trace-scoped
...
(ADR-0026), or `sidecar` (ADR-0028 — the two-span AuthBridge wire-fact
