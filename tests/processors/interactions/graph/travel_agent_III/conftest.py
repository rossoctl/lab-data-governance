...
(`8ae1f64d4bb51b750168c6ef1e11a2d8`) referenced throughout ADR-0026 and the
...
also stays in the parent conftest as the shared ADR-0026 reference constant.
"""
...
def canonical_trace_spans() -> list[Span]:
    """Spans of the canonical travel-advisor trace (ADR-0026 examples)."""
