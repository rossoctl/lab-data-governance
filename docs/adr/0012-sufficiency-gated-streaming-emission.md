...
The prototype (`p_interactions_proto/procedure.py`) validated this model
against the demo trace with the `--scramble` (reversed-arrival) acceptance
gate producing byte-identical output. Three refinements to the bullet above
