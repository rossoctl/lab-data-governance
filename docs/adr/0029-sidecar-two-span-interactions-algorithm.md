...
`docs/sidecar-wire-contract.md`, v1.1) — and this ADR lands its writer as
...
never fabricated defaults. The UI's infrastructure filter consumes
`kinds.request_content_kind`.
